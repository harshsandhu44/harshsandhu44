...
function AlertDescription({
  ...
  return (
    <div
      ...
      className={cn(
        "text-muted-foreground [&_a]:underline-offset-3 [&_a]:hover:text-foreground text-balance text-xs/relaxed md:text-pretty [&_a]:underline [&_p:not(:last-child)]:mb-2",
        className,
      )}
      {...props}
    />
...
function AlertAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "absolute right-[calc(--spacing(1.25))] top-[calc(--spacing(1.25))]",
        className,
      )}
      {...props}
    />
